...
public class AntonbookstoreApplication {
	...
	public CommandLineRunner loadData(BookRepository bookRepository, CategoryRepository categoryRepository){
		return (args) -> {
			...
			Category action = categoryRepository.save(new Category("Action"));
			Category fiction = categoryRepository.save(new Category("Fiction"));

			bookRepository.save(new Book("Kirja 1", "Kirjailija 1", 1111, "1111111111111", new BigDecimal("11.11"), fiction));
			bookRepository.save(new Book("Kirja 2", "Kirjailija 2", 2222, "2222222222222", new BigDecimal("22.22"), action));
			bookRepository.save(new Book("Kirja 3", "Kirjailija 3", 3333, "3333333333333", new BigDecimal("33.33"), action));
		};
	}
